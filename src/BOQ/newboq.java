...
public class newboq extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel35.setText("estimate cost");
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel27, javax.swing.GroupLayout.Alignment.CENTER, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
         ...
         try {
           ...
           Statement st= db.getconnection().createStatement();
           ResultSet ss =st.executeQuery("SELECT * FROM projects WHERE Proj_id='"+a+"' ");
            ...
            while(ss.next())
            {
                ...
                String l7=ss.getString(8);
                String l8=ss.getString(8);
                String l9=ss.getString(8);
...
char c = evt.getKeyChar();
    ...
    dtm.setRowCount(0);
        try {
           ...
           ResultSet rs= db.getconnection().createStatement().executeQuery("select * from projects where Proj_id Like'"+search+"%'");
              while(rs.next()){  
                Vector v = new Vector();
    ...
    public  void tableloadpro(){
        ...
        dtm.setRowCount(0);
         try {
           ResultSet rs= db.getconnection().createStatement().executeQuery("select * from projects");
