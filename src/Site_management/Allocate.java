...
void run(){
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(94, 127, 200, -1));
        ...
        jLabel47.setText("jLabel22");

        jLabel48.setText("jLabel23");

        jTextField6.setText("jTextField3");

        jLabel49.setText("Woorking hours");

        jComboBox5.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Construction Supervisor", "Field Supervisor" }));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        jLabel10.setText(jTable1.getModel().getValueAt(row, 4)+"");
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        try {
            ...
            if(s111=="By Name"){
                ...
                ResultSet rs11= db.getconnection().createStatement().executeQuery("select fname,lname,idemployee,contactno,address,email,occupation from employee where occupation='"+spec+"' and idemployee = '"+eng111+"' ");
                ...
                ResultSet rs12= db.getconnection().createStatement().executeQuery("select fname,lname,idemployee,contactno,address,email,occupation from employee where occupation like'%engineer%' ");
